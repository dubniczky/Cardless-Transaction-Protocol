...
# The original transaction STP signed by the vendor and encrypted using the metadata.enc method in base64 format
original_token: eyJtZXRhZGF0YSI6eyJ2ZXJzaW9uIjoxLCJhbGciOiJzaGE1MTIiLCJlbmM...
# The refreshed transaction STP signed by the vendor and encrypted using the metadata.enc method in base64 format
refreshed_token: eyJtZXRhZGF0YSI6eyJ2ZXJzaW9uIjoxLCJhbGciOiJzaGE1MTIiLCJlbmM...
```
...
# The original transaction STP signed by the vendor and encrypted using the metadata.enc method in base64 format
original_token: eyJtZXRhZGF0YSI6eyJ2ZXJzaW9uIjoxLCJhbGciOiJzaGE1MTIiLCJlbmM...
# The modified transaction STP signed by the vendor and encrypted using the metadata.enc method in base64 format
modified_token: eyJtZXRhZGF0YSI6eyJ2ZXJzaW9uIjoxLCJhbGciOiJzaGE1MTIiLCJlbmM...
```
